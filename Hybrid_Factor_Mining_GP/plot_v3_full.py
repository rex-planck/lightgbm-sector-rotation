...
if os.path.exists(results_path):
    ...
    plt.plot(df.index, df['cumulative_return'], label='V3 Full Strategy')
    plt.title('V3 Strategy Backtest Performance (Full Run)', fontsize=16)
    ...
    # Save
    output_path = 'Tushare/Hybrid_Factor_Mining_GP/output_v3/backtest/v3_full_performance.png'
